def load_parameters():
    ...
    """
    # Input data params
    DATA_ROOT_PATH = '/mnt/DATA/antonio/datasets/ted/enfr/joint_bpe'
    SRC_LAN = 'en'  # Language of the source text
    TRG_LAN = 'fr'  # Language of the target text

    # preprocessed features
    DATASET_NAME = 'ted-linked'   # Dataset name (add '-linked' suffix for using
    ...
    EVAL_EACH = 25000                             # Sets the evaluation frequency (epochs or updates)
    ...
    START_SAMPLING_ON_EPOCH = 2                   # First epoch where the model will be evaluated
    SAMPLE_EACH_UPDATES = 850                     # Sampling frequency (default 450)
    ...
    INPUT_VOCABULARY_SIZE = 24000                     # Size of the input vocabulary. Set to 0 for using all,
    MAX_INPUT_TEXT_LEN = 30
    MAX_INPUT_TEXT_LEN_TEST = MAX_INPUT_TEXT_LEN * 2
    MIN_OCCURRENCES_INPUT_VOCAB = 0

    # Output text parameters
    OUTPUT_VOCABULARY_SIZE = 24000                    # Size of the input vocabulary. Set to 0 for using all,
    ...
    # Input text parameters
    TARGET_TEXT_EMBEDDING_SIZE = 250              # Source language word embedding size (ABiViRNet 301)
    ...
    ENCODER_HIDDEN_SIZE = 250                     # For models with RNN encoder (ABiViRNet 717)
    ...
    PREV_SENT_ENCODER_HIDDEN_SIZE = 250           # For models with previous sentence RNN encoder (484)
    ...
    DECODER_HIDDEN_SIZE = 250                     # For models with LSTM decoder (ABiViRNet 484)
    ...
    STORE_PATH = '/mnt/DATA/antonio/trained_models/' + MODEL_NAME  + '_TMA/' # Models and evaluation results will be stored here
