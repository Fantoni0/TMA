def load_parameters():
    ...
    """
    # Input data params
    DATA_ROOT_PATH = '/home/fantonio/datasets/xerox/enfr/lowercased/joint_bpe' #'/home/fantonio/software/nmt-keras/examples/EuTrans' \
    SRC_LAN = 'en'  # Language of the source text
    TRG_LAN = 'fr'  # Language of the target text

    # preprocessed features
    DATASET_NAME = 'xerox-linked'   # Dataset name (add '-linked' suffix for using
    ...
    SAMPLE_EACH_UPDATES = 1500                     # Sampling frequency (default 450)
    ...
    MAX_OUTPUT_TEXT_LEN_TEST = 60                 # Maximum length of the output sequence during test time
    ...
    BATCH_SIZE = 40                              # ABiViRNet trained with BATCH_SIZE = 64
    ...
    DECODER_RNN_TYPE = 'LSTM'  # RNN unit type ('LSTM' supported)
    # Added parameters with respect original config
    SOURCE_TEXT_EMBEDDING_SIZE = 350
    ...
    # Input text parameters
    TARGET_TEXT_EMBEDDING_SIZE = 350              # Source language word embedding size (ABiViRNet 301)
    ...
    ENCODER_HIDDEN_SIZE = 350                     # For models with RNN encoder (ABiViRNet 717)
    ...
    PREV_SENT_ENCODER_HIDDEN_SIZE = 350           # For models with previous sentence RNN encoder (484)
    ...
    DECODER_HIDDEN_SIZE = 350                     # For models with LSTM decoder (ABiViRNet 484)
