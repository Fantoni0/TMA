def load_parameters():
    ...
    STEP_LINKS = True                                            # Whether pre-calculate link indexes or go across the whole dataset
    PREV_SENT_LAN = SRC_LAN                                        # Whether if we use the previous source sentence
                                                                 #
    ...
    EVAL_EACH = 1200                               # Sets the evaluation frequency (epochs or updates)
    ...
    SAMPLE_EACH_UPDATES = 2000                     # Sampling frequency (default 450)
    ...
    MAX_OUTPUT_TEXT_LEN_TEST = 70                 # Maximum length of the output sequence during test time
    ...
    BATCH_SIZE = 35                              # ABiViRNet trained with BATCH_SIZE = 64
    ...
    PREV_SENT_ENCODER_HIDDEN_SIZE = 400           # For models with previous sentence RNN encoder (484)
