...
def parse_args():
    ...
    parser.add_argument("-tl", "--text_links", required=True, help="Text file with linked indexes")
...
if __name__ == "__main__":
    ...
    dataset = update_dataset_from_file(dataset, args.text, args.text_links, params, splits=args.splits, remove_outputs=True)
    ...
    for s in args.splits:
        ...
        if args.n_best:
            predictions, n_best = beam_searcher.predictBeamSearchNet(dataset, params_prediction)[s]
        else:
            predictions = beam_searcher.predictBeamSearchNet(dataset, params_prediction)[s]
            n_best = None
